...
public class EntitySearcher5 extends EntitySearcher {
	...
	public ArrayList<EntityProposals> searchEntity(
		...
		if(printMatchingDetails) System.out.println("EntitySearcher5: search '"+entityphrase+"[orig="+originalentityphrase+"]'");
		...
		if(aentityphrase.indexOf(" ")<0){
			...
			if(regexpresults!=null){
				if(printMatchingDetails) System.out.println("...search entity '"+aentityphrase+" .*' found match");
				...
				if(printMatchingDetails) System.out.println("...search entity '"+aentityphrase+" .*' found no match");
			}
			
			if(nouns != null){
				if(printMatchingDetails) System.out.println("...found candidate headnouns '"+nouns+"', forming proposals...");
				...
				for(String noun: choices){
					...
					ep.add(sentity);
					if(printMatchingDetails) System.out.println(".....add a proposal:"+sentity);
					found = true;
				}
				//entities.add(ep);
				if(found){
					...
					//logging
					if(printMatchingDetails) System.out.println("EntitySearcher5 completed search for '"+aentityphrase+"[orig="+originalentityphrase+"]' and returns:");
				...
				if(printMatchingDetails) System.out.println("...candidate headnouns is null, search failed");
			}
				/*else{
		...
		if(printMatchingDetails) System.out.println("EntitySearcher5 calls EntitySearcher6");
