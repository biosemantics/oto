...
public class OntologyQuerySoapBindingStub extends org.apache.axis.client.Stub implements Query {
    ...
    private static void _initOperationDesc2(){
        ...
        oper.setReturnClass(DataHolder[].class);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {termId, ontologyName});
  ...
  throw axisFaultException;
    ...
    public DataHolder[] getTermsByAnnotationData(java.lang.String ontologyName, java.lang.String annotationType, java.lang.String strValue, double fromDblValue, double toDblValue) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {ontologyName, annotationType, strValue, new java.lang.Double(fromDblValue), new java.lang.Double(toDblValue)});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (DataHolder[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (DataHolder[]) org.apache.axis.utils.JavaUtils.convert(_resp, DataHolder[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
