 ...
 *
 */
public class QueryServiceLocator extends org.apache.axis.client.Service implements QueryService {
    ...
    public Query getOntologyQuery(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	OntologyQuerySoapBindingStub _stub = new OntologyQuerySoapBindingStub(portAddress, this);
