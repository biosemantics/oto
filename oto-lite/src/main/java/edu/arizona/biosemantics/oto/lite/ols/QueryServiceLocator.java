 ...
 *
 */
public class QueryServiceLocator extends org.apache.axis.client.Service implements edu.arizona.biosemantics.oto.lite.ols.QueryService {
    ...
    public edu.arizona.biosemantics.oto.lite.ols.Query getOntologyQuery(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	edu.arizona.biosemantics.oto.lite.ols.OntologyQuerySoapBindingStub _stub = new edu.arizona.biosemantics.oto.lite.ols.OntologyQuerySoapBindingStub(portAddress, this);
