...
<table border="1" width="100%">
 ...
 %>
						...
						<input type="hidden" id="hiddenvalue" name="value" />&nbsp;&nbsp;&nbsp;<img
							...
							style="visibility: hidden" width="15px;" /></form>
						</td>
					</tr>
				</table>
				</th>
			...
			<tr>
				...
				<table class="tagsTable" >
					...
					<tr>
						...
						<img title="View specific hierarchy report for <%=tag.getName()%>"
							...
							width="12px" style="vertical-align: middle; cursor: pointer;"></img></div>
						</td>
					</tr>
					<%
						}
 ...
 %>
				...
				<td><!-- below is the table of hierarchy tree  -->
				<div id="hierarchyTree" style="height: 420px; overflow: auto; padding-left: 8px">
				<div class="dtree">
