...
import edu.arizona.biosemantics.util.PasswordGenerator;
...
public class UserDataAccess extends DatabaseAccess {
	...
	public boolean validateUser(User user) throws SQLException,
		...
		EncryptDecrypt enc = EncryptDecrypt.getInstance();
	...
	public boolean registerUser(User user) throws Exception {
		...
		try {
			...
			String userFilePath = properties.getProperty("USER_FILE_PATH");
