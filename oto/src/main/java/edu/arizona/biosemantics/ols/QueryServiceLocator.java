 ...
 *
 */
public class QueryServiceLocator extends org.apache.axis.client.Service implements edu.arizona.biosemantics.ols.QueryService {
    ...
    public edu.arizona.biosemantics.ols.Query getOntologyQuery(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	edu.arizona.biosemantics.ols.OntologyQuerySoapBindingStub _stub = new edu.arizona.biosemantics.ols.OntologyQuerySoapBindingStub(portAddress, this);
